...
public class KuchenAutomat {
    ...
    public boolean create(Hersteller hersteller, BigDecimal preis, int naehrwert,
                          Collection<Allergen> allergene, Krem krem) {
        return insert(hersteller, new KremkuchenImpl(preis, naehrwert, allergene, krem));
    }

    public boolean create(Hersteller hersteller, BigDecimal preis, int naehrwert,
                          Collection<Allergen> allergene, Obst obst) {
        return insert(hersteller, new ObstkuchenImpl(preis, naehrwert, allergene, obst));
    }

    public boolean create(Hersteller hersteller, BigDecimal preis, int naehrwert,
                          Collection<Allergen> allergene, Krem krem, Obst obst) {
        return insert(hersteller, new ObsttorteImpl(preis, naehrwert, allergene, krem, obst));
    }
